...
<html data-wf-page="68df53b2eb89388e975072c3" data-wf-site="68df53afeb89388e97507271" lang="en">
<head>
    <meta charset="utf-8">
    <title>Contact</title>
                    ...
                    <div class="section-padding-large">
                        <div class="w-layout-grid contact-component">
                            <div data-w-id="5e73b729-bbe1-c93e-0326-062008d42606" style="opacity:0" class="contact-form-block w-form">
                                ...
                                <form action="newprofile.php" method="POST" class="formulario-usuario" style="max-width:800px; margin:auto;">

                                    <!-- Sección 1: Información de Usuario -->
                                    <fieldset style="margin-bottom: 2rem; padding: 1.5rem; border: 1px solid #ccc; border-radius: 8px;">
                                        <legend style="font-weight:bold; padding: 0 10px;">Información de Usuario</legend>

                                        <div class="form-field-2col" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="login">Nombre de Usuario</label>
                                                <input type="text" id="login" name="login" placeholder="Ingrese su nombre de usuario" maxlength="256" required>
                                            </div>

                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="pwd">Contraseña</label>
                                                <input type="password" id="pwd" name="pwd" placeholder="Ingrese su contraseña" maxlength="256" minlength="10" required>
                                            </div>
                                        </div>

                                        <div class="form-field-wrapper" style="margin-top:1rem;">
                                            <label for="pwd2">Repetir Contraseña</label>
                                            <input type="password" id="pwd2" name="pwd2" placeholder="Repita su contraseña" maxlength="256" minlength="10" required>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset style="margin-bottom: 2rem; padding: 1.5rem; border: 1px solid #ccc; border-radius: 8px;">
                                        <legend style="font-weight:bold; padding: 0 10px;">Información Personal</legend>

                                        <div class="form-field-2col" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="firstname">Nombres</label>
                                                <input type="text" id="firstname" name="firstname" placeholder="Ingrese sus nombres" maxlength="256" required>
                                            </div>
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="lastname">Apellidos</label>
                                                <input type="text" id="lastname" name="lastname" placeholder="Ingrese sus apellidos" maxlength="256" required>
                                            </div>
                                        </div>

                                        <div class="form-field-wrapper" style="margin-top:1rem;">
                                            <label for="email">Correo Electrónico</label>
                                            <input type="email" id="email" name="email" placeholder="Ingrese su correo electrónico" maxlength="256" required>
                                        </div>
                                    </fieldset>

                                    <!-- Sección 3: Opcionales -->
                                    <fieldset style="margin-bottom: 2rem; padding: 1.5rem; border: 1px solid #ccc; border-radius: 8px;">
                                        <legend style="font-weight:bold; padding: 0 10px;">Opcionales (Recomendados)</legend>

                                        <div class="form-field-2col" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="title">Título</label>
                                                <input type="text" id="title" name="title" placeholder="Ingrese su título" maxlength="256">
                                            </div>
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="institution">Institución</label>
                                                <input type="text" id="institution" name="institution" placeholder="Ingrese su institución" maxlength="256">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-field-2col" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                            <div class="form-field-wrapper" style="flex:1;">
                                                ...
                                                <input type="text" id="city" name="city" placeholder="Ingrese su ciudad" maxlength="256">
                                            </div>
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="state">Estado</label>
                                                <input type="text" id="state" name="state" placeholder="Ingrese su estado" maxlength="256">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-field-2col" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                            <div class="form-field-wrapper" style="flex:1;">
                                                ...
                                                <input type="text" id="zip" name="zip" placeholder="Ingrese su código postal" maxlength="256">
                                            </div>
                                            <div class="form-field-wrapper" style="flex:1;">
                                                <label for="country">País</label>
                                                <input type="text" id="country" name="country" placeholder="Ingrese su país" maxlength="256">
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <div style="text-align:center; margin-top:2rem;">
                                        <button type="submit" name="submit" value="Create Login" style="padding: 0.75rem 2rem; font-size:1rem;">Registrarse</button>
                                    </div>
